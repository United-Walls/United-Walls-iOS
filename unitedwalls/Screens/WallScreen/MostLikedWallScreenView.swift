    ...
    var body: some View {
        ZStack(alignment: .bottomTrailing) {
            ...
            .onChange(of: contentViewViewModel.wallIndex) { index in
                ...
                apiManager.loadUploaderFromWallId(wallId: apiManager.mostFavouritedWalls[index]._id)
            ...
            .onAppear {
                if (contentViewViewModel.wallIndex >= 0 && apiManager.mostFavouritedWalls.count > contentViewViewModel.wallIndex) {
                    selectedWall = apiManager.mostFavouritedWalls[contentViewViewModel.wallIndex]
                    apiManager.loadUploaderFromWallId(wallId: apiManager.mostFavouritedWalls[contentViewViewModel.wallIndex]._id)
                } else {
